...
struct qt_meta_stringdata_CLASSUserInfoWidgetENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSUserInfoWidgetENDCLASS = QtMocHelpers::stringData(
    "UserInfoWidget",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSUserInfoWidgetENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject UserInfoWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSUserInfoWidgetENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSUserInfoWidgetENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSUserInfoWidgetENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<UserInfoWidget, std::true_type>,
...
void *UserInfoWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSUserInfoWidgetENDCLASS.stringdata0))
